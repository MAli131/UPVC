...
namespace UPVC.Migrations
{
    ...
    [Migration("20251122005726_assww")]
    partial class assww
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UPVC.Models.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            PasswordHash = "$2a$11$ILOvwUmkX64iOFXjBXeF6.VHZluSj44hyxuzASWu2mWPk2Aj.fnG.",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("UPVC.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BrochurePath = "/files/brochure/EMA-42S.pdf",
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            NameAr = "EMA-42S",
                            NameEn = "Ema-42s",
                            SubtitleAr = "البديل الإقتصادي لنظام EMA-60S مخصص للنوافذ الأصغر السعر والأوفر، مع الحفاظ على العزل و المتانة التي تحتاجها لنوافذك.",
                            SubtitleEn = "ECONOMIC SLIDING WINDOW SYSTEM"
                        },
                        new
                        {
                            Id = 2,
                            BrochurePath = "/files/brochure/EMA-60.pdf",
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            NameAr = "EMA-60",
                            NameEn = "EMA-60",
                            SubtitleAr = "الإختيار الأمثل لضمان أقصى تهوئة من خلال النوافذ. بالإضافة الى ذلك فإن الإغلاق المحكم للقطاع يوفر عزلا صوتيا أعلى من الأنظمة الاخرى.",
                            SubtitleEn = "THE DEFINITIVE CASEMENT WINDOW\nAND DOOR SYSTEM"
                        },
                        new
                        {
                            Id = 3,
                            BrochurePath = "/files/brochure/EMA-60S.pdf",
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            NameAr = "EMA-60S",
                            NameEn = "EMA-60S",
                            SubtitleAr = "الإختيار النموذجي لنوافذ الجرار الخاصة بك، ملائم للفتحات الكبيرة التي تتيح لك الإستمتاع بالمنظر الخارجي. علاوة على ذلك، فإن الحركة الأفقية لأنظمة الجرار تجعلها أكثر ملائمة للمساحات الداخلية المحدودة",
                            SubtitleEn = "STANDARD SLIDING WINDOW SYSTEM"
                        },
                        new
                        {
                            Id = 4,
                            BrochurePath = "/files/brochure/EMA-STYLE.pdf",
                            CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            NameAr = "EMA-STYLE",
                            NameEn = "EMA-STYLE",
                            SubtitleAr = "نظام الجرار الجديد و المتطور من EMAPEN, الذي يقدم ضلفة لباب جرار بجودة استثنائية وحلق ببار ٦ سم. يتميز النظام أيضا بأعلى سمك خارجي في مجموعتنا، مما يوفر أقصى درجات المتانة و العزل.",
