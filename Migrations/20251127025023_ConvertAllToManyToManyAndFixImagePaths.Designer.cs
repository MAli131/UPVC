...
namespace UPVC.Migrations
{
    ...
    [Migration("20251127025023_ConvertAllToManyToManyAndFixImagePaths")]
    partial class ConvertAllToManyToManyAndFixImagePaths
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UPVC.Models.AdminUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            PasswordHash = "$2a$11$hY1cG.FW2BHHyEIs/isTquDRJ52tifARFFhcwJSxDbSvwM.MJqNjq",
                            Username = "admin"
                        });
                });
